...
public class TankShell extends RotatingObject{
	...
	public TankShell(TankTurret connectedTankTurret, String texturePath, Window window, float shellSpeed, LevelContainer levelContainer) 
	{
		boolean hasFired = false;
		this.window = window;
		this.shellSpeed = shellSpeed;
		this.levelContainer = levelContainer;
		this.map = this.levelContainer.getMap();
	...
	{
		ArrayList<Tank> enemyList = levelContainer.getEnemyList();
